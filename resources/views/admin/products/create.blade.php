        ...
        <div class="col-md-12 ">
            <div class="card">
                <div class="card-header">
                    <h3>Add Product
                        <a href="{{ url('admin/products') }}" class="btn btn-danger btn-sm text-white float-end">Add
                            Back</a>
                    </h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade border p-3 " id="seotag-tab-pane" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_keyword" class="form-control" rows="4">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade border p-3 " id="color-tab-pane" role="tabpanel"
                                aria-labelledby="colo-tab" tabindex="0">
                                <div class="mb-3">
